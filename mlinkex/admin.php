<?php
	...
	function mt_add_pages() {
		global $dbdata;
		add_menu_page('Link Exchange', 'Link Exchange', 'administrator', 'mlinkex', 'mlinkex', plugins_url('mlinkex/link.png'));
		...
		if(isInstalled()){
			...
			// add_submenu_page('mlinkex', 'Updates', 'Updates <span class="update-plugins count-1" style="background:#a40000;"><span class="plugin-count">new updates</span></span>', 'administrator', 'mlinkex_updates', 'mlinkex_updates');
		}else{
				...
				<form action="admin.php?page=mlinkex_links" method="post">
					<table class="wp-list-table widefat fixed bookmarks" cellspacing="0">
						...
						<tr>
							...
							<th scope="col" id="name" class="manage-column column-name sortable desc" style=""><span>Achor</span></th>
							<th scope="col" id="url" class="manage-column column-url sortable desc" style=""><span>URL</span></th>
							<th scope="col" id="categories" class="manage-column" style="width:110px;">External Links</th>
							<th scope="col" id="categories" class="manage-column" style="width:110px;">Internal Links</th>
							<th scope="col" id="visible" class="manage-column" style="width:80px;"><span>Pagerank</span></th>
							<th scope="col" id="rating" class="manage-column" style="width:100px;"><span>Date added</span></th>
							<th scope="col" id="rating" class="manage-column" style="width:70px;"><span>Status</span></th>
						</tr>
						</thead>
						<tbody id="the-list">
							<?php
